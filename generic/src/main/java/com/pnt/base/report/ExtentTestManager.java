...
public class ExtentTestManager {
    ...
    private static ExtentReports extent = com.pnt.base.report.ExtentManager.getInstance();
    private static ExtentReports extentUpdate = com.pnt.base.report.ExtentManager.getInstance();
